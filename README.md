# TKver5.0 - App Center Direct / Permission Excel
...
# TKver5.0 - App Center Cleanup + Apps Folder
...
# TKver5.0 - Repair Build

- Sửa lỗi JavaScript ở popup Thiên Kim Care khiến web có thể không chạy.
- Giữ theme Black Gold.
- Version tag: TKver5.0.

# TKver5.0 - Black Gold Edition

## Cập nhật
- Thêm version tag nhỏ góc phải dưới: `TKver5.0`.
...
- Đồng bộ màu chủ đạo cho các trang/domain con:
  ...
  - vault
  - pages/module.html
- Giữ nguyên toàn bộ chức năng của TKver5.0.


# TKver5.0 - Thiên Kim Care Popup
...
# TKver5.0 - Family Role + Profile Sharing
...
# TKver5.0 - Flex Profile Timeline
...
# TKver5.0 - Linked Modules + Demo Pages + App Center
...
Bản tiếp theo mặc định là TKver5.0.


# TKver5.0 - Test Accounts Full Access
...
# TKver5.0 - Professional Module Architecture
...
# TKver5.0 - Small Center Login Star
...
## Quy ước version
- Bản hiện tại: TKver5.0
- Bản tiếp theo: TKver5.0
- Sau TKver5.0 sẽ lên TKver5.0

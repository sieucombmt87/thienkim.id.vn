# TKver5.1 - App Center Direct / Permission Excel
...
# TKver5.1 - App Center Cleanup + Apps Folder
...
# TKver5.1 - Repair Build

- Sửa lỗi JavaScript ở popup Thiên Kim Care khiến web có thể không chạy.
- Giữ theme Black Gold.
- Version tag: TKver5.1.

# TKver5.1 - Black Gold Edition

## Cập nhật
- Thêm version tag nhỏ góc phải dưới: `TKver5.1`.
...
- Đồng bộ màu chủ đạo cho các trang/domain con:
  ...
  - vault
  - pages/module.html
- Giữ nguyên toàn bộ chức năng của TKver5.1.


# TKver5.1 - Thiên Kim Care Popup
...
# TKver5.1 - Family Role + Profile Sharing
...
# TKver5.1 - Flex Profile Timeline
...
# TKver5.1 - Linked Modules + Demo Pages + App Center
...
Bản tiếp theo mặc định là TKver5.1.


# TKver5.1 - Test Accounts Full Access
...
# TKver5.1 - Professional Module Architecture
...
# TKver5.1 - Small Center Login Star
...
## Quy ước version
- Bản hiện tại: TKver5.1
- Bản tiếp theo: TKver5.1
- Sau TKver5.1 sẽ lên TKver5.1

...
const TK_APP_TOOLS = [
  { key:"random-race", title:"Random Race", desc:"Quay random bằng hiệu ứng cuộc đua, Top 1/Top 3 và lịch sử.", icon:"assets/images/app-icons/random-race.svg", vip:false },
  ...
  {key:"random-race",  title:"Random Race",  desc:"Quay random bằng hiệu ứng cuộc đua",  icon:"assets/images/app-icons/random-race.png",  vip:false}
...
// TKver5.0: chỉ role VIP hoặc user 0947924444 được quyền set app VIP/thường

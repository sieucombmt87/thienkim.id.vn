...
const ROLE_LABELS={"Admin":"👑 Admin","Boss":"💼 Boss","Leader":"🚀 Leader","Trưởng ca":"📋 Trưởng ca","TVBH":"🛒 TVBH","Family":"👨‍👩‍👧 Family"};
const ROLE_PERMISSIONS={"Admin":["dashboard","profile","learning","vip","sales","tools","user_manager","role_manager","sheet_sync","settings","app_manager"],"Boss":["dashboard","profile","learning","vip","sales","tools","user_manager","role_manager","sheet_sync","settings","reports"],"Leader":["dashboard","learning","vip","sales","tools","reports"],"Trưởng ca":["dashboard","sales","tools","reports"],"TVBH":["sales","tools"],"Family":["dashboard","profile","profile_manager","learning","academy_manager","tools"]};
...
/* TKver2.3 - Session history + 80-minute inactivity timeout */

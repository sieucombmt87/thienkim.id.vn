...
function addScanned(value){value=String(value||"").trim();if(!value)return;scanned=scanned.filter(x=>x.value!==value);scanned.unshift({value,state:"ok",deleted:false});lastSingleAdded=value;saveList();renderAll();}

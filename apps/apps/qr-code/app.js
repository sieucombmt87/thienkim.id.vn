/* TKver9.0 QR Code Pro: 3 clean modes */
...
/* TKver9.0 safer camera constraints */
...
/* TKver9.0 embedded inventory camera */
...
/* TKver9.0 native barcode first + advanced QR runner */
...
/* TKver9.0 sticky result + no manual scan buttons */
...
/* TKver9.0 inventory one-hand controls + mobile inline actions */
...
/* TKver9.0 inventory scan throttle */
let invLastAcceptedAt=0;
let invLastAcceptedCode='';


/* TKver9.0 scan cooldown modes */
...
/* TKver9.0 FINAL OVERRIDES: QR/Barcode strict + real scan cooldown */
(function(){
  const TK83_SPEEDS = {
...
/* TKver9.0 hard QR/Barcode renderer + inventory UX */
...
/* TKver9.0 HARD OVERRIDE: QR/Barcode renderer + normal scan list + inventory cleanup */
(function(){
...
/* TKver9.0 restore inventory toolbar wiring */
(function(){
  const $=(id)=>document.getElementById(id);
...
/* TKver9.0 FIX inventory buttons real actions */
(function(){
...
/* TKver9.0 FIX QR runner actual render + blue highlight */
(function(){
  const $=(id)=>document.getElementById(id);
...
/* TKver9.0 FIX REAL IDS: create runner + copy/export data */
(function(){
  const $ = id => document.getElementById(id);
  const esc = s => String(s ?? "").replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;","\"":"&quot;","'":"&#039;"}[m]));
  const state = {
